...
```
# Site settings
title: Joyce Blog             # 你的博客网站标题
SEOTitle: Hello! Better Me	    # 在后面会详细谈到
description: "活着凭什么不努力 | 陈花花 | Better & Better。"    # 随便说点，描述一下
...
# Sidebar settings
sidebar: true  #添加侧边栏
sidebar-about-description: "开开心心简简单单已极好"
sidebar-avatar: /img/avatar-Joyce.jpg     #你的大头贴，请使用绝对地址.
```
